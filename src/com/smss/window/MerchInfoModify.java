...
public class MerchInfoModify {
	 ...
	 */
	public MerchInfoModify(DefaultTableModel JTableModel,int x) {
		frame = new JFrame();
		...
		JLabel labMerchID = new JLabel("商品ID");
		...
		btnSure.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				merchInfo.setMerchID(labMerchID.getText().toString());
				...
				DAOFactory.getMerchInfoInstance().update(merchInfo);
				frame.dispose();
			}
		});
